eval(function (p, a, c, k, e, r) {
    ...
    return p
}('a.f(\' %c 9 1 %c b://d.e/8/1\',\'2:#3;4:#5;6:7 0\',\'2:#5;4:#3;6:7\');', 16, 16, '|cdnmc|color|444|background|eee|padding|5px|dyedd|Theme|console|https||github|com|log'.split('|'), 0, {}));
...
let cdnmc = {
    ...
    addCoupleTime: () => {
        ...
        function setTime() {
            ...
            document.getElementById('our-time2').innerHTML = '建站时间：' + '<span>' + currentTime[0] + '</span>' + '<svg class="icon" aria-hidden="true">\n' +
