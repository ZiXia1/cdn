...
(function () {
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const authorInfo = '<h1 class="theme-plane">CDNMC 主题设置面板</h1>' +
            '<p>作者博客：<a href="https://blog.cdnmc.cn">籽夏</a></p>' +
            ...
            if (xhr.readyState === 4) {
                if ((xhr.status >= 200 && xhr.status < 300) || xhr.status === 304) {
                    ...
                    if (res.tag_name !== Version.innerHTML) {
                        str = `<a class="update" target="_blank" href="https://github.com/ZiXia1/cdn/releases/tag/${res.tag_name}">检测到版本更新！</a>`
                    } else {
        ...
        xhr.open('get', 'https://api.github.com/repos/ZiXia1/cdn/releases/latest', true);
        xhr.send(null);
    });
})();
